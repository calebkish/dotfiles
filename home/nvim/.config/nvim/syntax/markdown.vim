...
if !exists('g:markdown_fenced_languages')
  " @CHANGE: Being lazy and setting this manually
  " let g:markdown_fenced_languages = []
  let g:markdown_fenced_languages = ['json', 'typescript', 'css', 'html', 'bash=sh', 'sass', 'javascript', 'lua', 'c', 'asm']
endif
let s:done_include = {}
...
" @CHANGE: Remove indented `markdownCodeBlock`s
" syn region markdownCodeBlock start="    \|\t" end="$" contained

" @CHANGE: Apply list markers for up to 4 indentation levels (4 * 4 = 16)
